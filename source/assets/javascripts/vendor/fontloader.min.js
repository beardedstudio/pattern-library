/*
 ...
 MyFonts Webfont Build ID 2857338, 2014-08-04T16:09:19-0400
 ...
 Webfont: Petala Pro Light by Typefolio
 URL: http://www.myfonts.com/fonts/typefolio/petala-pro/light/
 Copyright: Copyright (c) 2013 by Marconi Lima/Typefolio Digital Foundry. All rights reserved.


 License: http://www.myfonts.com/viewlicense?type=web&buildid=2857338
 Licensed pageviews: 10,000

 ? 2014 MyFonts Inc
*/
var protocol=document.location.protocol;"https:"!=protocol&&(protocol="http:");var count=document.createElement("script");count.type="text/javascript";count.async=!0;count.src=protocol+"//hello.myfonts.net/count/2b997a";var s=document.getElementsByTagName("script")[0];s.parentNode.insertBefore(count,s);var browserName,browserVersion,webfontType;if("undefined"==typeof woffEnabled)var woffEnabled=!0;var svgEnabled=0;
...
for(var fonts=[{fontFamily:"Quadon-Regular",url:wfpath+"2B997A_0"+suffix+"_0."+webfontType},{fontFamily:"Quadon-RegularItalic",url:wfpath+"2B997A_1"+suffix+"_0."+webfontType},{fontFamily:"PetalaProLight",url:wfpath+"2B997A_2"+suffix+"_0."+webfontType}],len=fonts.length,css="",i=0;i<len;i++){var format="svg#wf"==webfontType?'format("svg")':"ttf"==webfontType?'format("truetype")':"eot"==webfontType?"":'format("'+webfontType+'")',css=css+("@font-face{font-family: "+fonts[i].fontFamily+";src:url("+fonts[i].url+
